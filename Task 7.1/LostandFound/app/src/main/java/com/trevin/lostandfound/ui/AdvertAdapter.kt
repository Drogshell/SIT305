        ...
        fun bind(advert: AdvertItem) {
            binding.apply {
                ...
                if (advert.postType.equals("lost", ignoreCase = true)) {
                    ...
                    textViewPostType.setTextColor(ContextCompat.getColor(binding.root.context, R.color.md_theme_secondary))
                    materialDivider.dividerColor = ContextCompat.getColor(binding.root.context, R.color.md_theme_secondary)
                } else if (advert.postType.equals("found", ignoreCase = true)) {
                    textViewPostType.text = advert.postType
                    textViewPostType.setTextColor(ContextCompat.getColor(binding.root.context, R.color.colorCustomColor2))
                    materialDivider.dividerColor = ContextCompat.getColor(binding.root.context, R.color.colorCustomColor2)
                }
